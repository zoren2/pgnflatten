...
for (const move of moveData) {
    if (move.match(legalMove)) {
        ...
        gameString = updatePGNMarkup(gameString,gameData); // Inserting and finalizing into Event Metadata
...
function updatePGNMarkup(gameString, gameData) {
    let editedEventData = gameData.event[0].slice(0, -2) + ": " + gameString + gameData.event[0].slice(-2);
